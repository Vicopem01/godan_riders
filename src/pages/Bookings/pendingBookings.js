...
import { getRiderActiveOrder } from "../../services/apiCalls";
...
const Deliveries = ({ history }) => {
  ...
  const getOrder = async () => {
    try {
      const res = await getRiderActiveOrder();
      ...
      {options && (
        ...
        >
          <ul className={classes.list}>
            ...
            <span></span>
            <li onClick={() => window.location.reload()}>In-Progress</li>
            <span></span>
